...
main_path = "task_2_phase_1/LA_EA"
config_path = "main_config/task_2_phase_1/LA_EA"
...
config_path = "main_config/task_2_phase_1/LA_EA"
main_path = "task_2_phase_1/LA_EA/tune_filter/1"
dataset_conditions = ["dataset_A_0","dataset_A_1", "dataset_B_0","dataset_B_1","dataset_B_2"]
norm_conditions = ["no_norm"]
aug_conditions=["no_aug"]
trainer_conditions = ["mcdV1"]
...
config_path = "main_config/task_2_phase_1/LA_EA"
main_path = "task_2_phase_1/LA_EA/tune_filter/2"
dataset_conditions = ["dataset_A_0","dataset_A_1", "dataset_B_0","dataset_B_1","dataset_B_2"]
norm_conditions = ["no_norm"]
aug_conditions=["no_aug"]
trainer_conditions = ["mcdV1"]
...
config_path = "main_config/task_2_phase_1/LA_EA"
main_path = "task_2_phase_1/LA_EA/tune_filter/3"
dataset_conditions = ["dataset_A_0","dataset_A_1", "dataset_B_0","dataset_B_1","dataset_B_2"]
norm_conditions = ["no_norm"]
aug_conditions=["no_aug"]
trainer_conditions = ["mcdV1"]
...
config_path = "main_config/task_2_phase_1/LA_EA"
main_path = "task_2_phase_1/LA_EA/tune_filter/4"
dataset_conditions = ["dataset_A_0","dataset_A_1", "dataset_B_0","dataset_B_1","dataset_B_2"]
norm_conditions = ["no_norm"]
aug_conditions=["no_aug"]
trainer_conditions = ["mcdV1"]
...
config_path = "main_config/task_2_phase_1/LA_EA"
main_path = "task_2_phase_1/LA_EA/tune_filter/5"
dataset_conditions = ["dataset_A_0","dataset_A_1", "dataset_B_0","dataset_B_1","dataset_B_2"]
norm_conditions = ["no_norm"]
aug_conditions=["no_aug"]
trainer_conditions = ["mcdV1"]
