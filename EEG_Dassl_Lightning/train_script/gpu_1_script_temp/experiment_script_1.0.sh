...
run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V0 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V1 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V2 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix

run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V0 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V1 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_2 $SEED_V2 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix

run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V0 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V1 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V2 $adaptation_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix

run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V0 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V1 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
run $gpu_device_1 $norm_none $experiment_type_3 $SEED_V2 $adapt_dann_aug_DSBN_prefix $norm_zscore_1_prefix $BCI_IV_MI_V3_prefix
