...
group_datasets=("$Physionet_dataset")
...
#run_full_multi_gpu $gpu_device_2 $experiment_2 group_aug group_norm group_model group_datasets


run_full_multi_gpu $gpu_device_2 $experiment_1 group_aug group_norm group_model group_datasets
