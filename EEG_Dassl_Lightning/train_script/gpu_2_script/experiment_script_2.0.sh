...
#echo ${EXP_SETUP[1]}
#
#run_full_active_learning $gpu_device_0 $test_path $model_update_al EXP_SETUP BEST_SETUP group_aug group_norm group_model group_datasets
...
#run_active_learning $gpu_device_0 $test_path $model_update_al EXP_SETUP BEST_SETUP group_aug group_norm group_model group_datasets

#group_datasets=("$Dataset_A_0_dataset" "$Dataset_A_1_dataset" "$Dataset_B_0_dataset" "$Dataset_B_1_dataset" "$Dataset_B_2_dataset")
#EXP_TYPE="NeurIPS_competition/final_result_15_3_1/main_model_4"
#PRETRAIN_EXP="NeurIPS_competition/final_result_14_3_1/main_model_2"
#USE_BEST_PRETRAIN_EXP="True"
#run_pretrain $gpu_device_0 $EXP_TYPE $PRETRAIN_EXP $USE_BEST_PRETRAIN_EXP group_aug group_norm group_model group_datasets
...
#      do
#        PRETRAIN_DIR="${prefix_path}${PRETRAIN_EXP}/${AUG_PREFIX}/${NORMALIZE_PREFIX}/${TRAINER_MODEL_PREFIX}/${PRETRAIN_DATASET}"
...
#        echo $PRETRAIN_DIR
#        echo $MAIN_DIR
#        run_simple_pretrain $gpu_device_0 $test_path $PRETRAIN_DIR $USE_BEST_PRETRAIN_EXP $MAIN_DIR
#
#      done
#    done
#  done
...
PRETRAIN="NeurIPS_competition/task_2_final_2"
MODEL_UPDATE="NeurIPS_competition/task_2_final_2"
...
MAIN_EXP_TYPE="NeurIPS_competition/task_2_final_2/al_pretrain"

#LIST_EXP_TYPES=("1" "2" "3")
LIST_EXP_TYPES=("")
...
#          run_simple_train $gpu_device_0 $test_path $MAIN_DIR
  ...
  #        PRETRAIN_DIR="empty"
          ...
          run_simple_active_learning $gpu_device_3 $test_path $PRETRAIN_DIR $USE_BEST_PRETRAIN_EXP $MAIN_DIR $MODEL_UPDATE_DIR
