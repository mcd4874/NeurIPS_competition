...
#group_model=("$adapt_dann_prefix" "$adaptation_prefix")
#group_model=("$adaptation_prefix")

group_seed=("seed_v0" "seed_v1" "seed_v2" "seed_v3" "seed_v4" "seed_v5" "seed_v6" "seed_v7" "seed_v8")
group_model=("$mldg_prefix")

group_datasets=("$BCI_IV_prefix" )

run_full_multi_gpu $gpu_device_0 $test_mldg $norm_none_prefix group_seed group_model group_datasets
