...
group_model=("$adapt_equal_label_prefix")
#group_model=("$adaptation_prefix")

#group_seed=("seed_v0" "seed_v1" "seed_v2" "seed_v3" "seed_v4" "seed_v5" "seed_v6" "seed_v7" "seed_v8")
group_seed=("seed_v2")

#group_seed=("seed_v0" "seed_v1" "seed_v2")
#group_seed=("seed_v3" "seed_v4" "seed_v5")
#group_seed=("seed_v6" "seed_v7" "seed_v8")
#group_datasets=("$BCI_IV_prefix" )
group_datasets=("$BCI_IV_MI_prefix" )

run_full_multi_gpu $experiment_3 $norm_none_prefix group_seed group_model group_datasets
