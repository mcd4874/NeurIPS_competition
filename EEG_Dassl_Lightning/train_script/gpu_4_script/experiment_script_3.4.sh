...
group_model=("$vanilla_prefix")
#run_full_multi_gpu $gpu_device_2 $task_1_exp_1 group_aug group_norm group_model group_datasets

run_predict_task_1 $gpu_device_2 $task_1_exp_1 $test_case_path group_aug group_norm group_model group_datasets