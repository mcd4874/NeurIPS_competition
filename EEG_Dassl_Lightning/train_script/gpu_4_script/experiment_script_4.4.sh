...
task_exp="NeurIPS_1/task_1_exp_5/al_model"
model_update_path="NeurIPS_1/task_1_exp_5"
#run_full_multi_gpu $gpu_device_2 $model_update_path group_aug group_norm group_model group_datasets
#run_predict_task_1 $gpu_device_2 $model_update_path $test_case_path group_aug group_norm group_model group_datasets

#task_exp="NeurIPS_1/task_1_exp_5/al_al_model"
#model_update_path="NeurIPS_1/task_1_exp_5/al_model"
run_al_full $gpu_device_2 $task_exp $test_case_path $model_update_path group_aug group_norm group_model group_datasets
