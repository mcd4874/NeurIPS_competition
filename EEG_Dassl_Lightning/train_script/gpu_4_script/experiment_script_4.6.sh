...
task_exp="NeurIPS_1/task_1_exp_5/al_pretrain_1"
...
#run_pretrain_al_full $gpu_device_2 $task_exp $test_case_path $model_update_path $pretrain_dir group_aug group_norm group_model group_datasets
#run_predict_task_1 $gpu_device_2 $task_exp $test_case_path group_aug group_norm group_model group_datasets

task_exp="NeurIPS_1/task_1_exp_5/al_al_pretrain_1"
model_update_path="NeurIPS_1/task_1_exp_5/al_pretrain_1"
pretrain_dir="NeurIPS_1/task_1_exp_5/al_pretrain_1"
run_pretrain_al_full $gpu_device_2 $task_exp $test_case_path $model_update_path $pretrain_dir group_aug group_norm group_model group_datasets
run_predict_task_1 $gpu_device_2 $task_exp $test_case_path group_aug group_norm group_model group_datasets