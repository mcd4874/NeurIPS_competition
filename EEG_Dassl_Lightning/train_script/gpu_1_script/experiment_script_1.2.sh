...
#PRETRAIN_EXP_TYPE="NeurIPS_competition/final_result_14_3_1/main_model_2/tune_opt"
...
current_exp="NeurIPS_competition/final_result_14_3_1/main_model_2/tune_opt"
LIST_EXP_TYPE=("$current_exp")
