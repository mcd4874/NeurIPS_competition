...
#run_full_multi_gpu $gpu_device_2 $experiment_4_4 group_aug group_norm group_model group_datasets
run_full_multi_gpu $gpu_device_2 $final_result_4_5 group_aug group_norm group_model group_datasets
run_ensemble_predict $gpu_device_2 $final_result_4_5 group_aug group_norm group_model group_datasets
