...
#group_model=("$adaptationV1_prefix")
#LIST_EXP_TYPE=("$final_result_12_4_1_0" "$final_result_12_4_1_1" "$final_result_12_4_1_2")
...
do
  ...
  do
    ...
    run_full_multi_gpu $gpu_device_2 $NEW_TYPE group_aug group_norm group_model group_datasets
