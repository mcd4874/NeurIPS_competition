...
do
  ...
  do
    ...
    run_pretrain $gpu_device_2 $NEW_TYPE $PRETRAIN_EXP_TYPE group_aug group_norm group_model group_datasets
#    run_train_only $gpu_device_2 $NEW_TYPE group_aug group_norm group_model group_datasets
...
#    run_full_multi_gpu $gpu_device_0 $NEW_TYPE group_aug group_norm group_model group_datasets
    run_predict_relabel $gpu_device_2 $NEW_TYPE $test_case_16_microvolt_path group_aug group_norm group_model group_datasets
  done
done
