...
#group_model=("$adaptation_prefix")
#run_full_multi_gpu $gpu_device_3 $experiment_2 group_aug group_norm group_model group_datasets


#run_full_multi_gpu $gpu_device_2 $experiment_3 group_aug group_norm group_model group_datasets
#run_full_multi_gpu $gpu_device_2 $final_result_4 group_aug group_norm group_model group_datasets
run_full_multi_gpu $gpu_device_2 $experiment_4 group_aug group_norm group_model group_datasets
