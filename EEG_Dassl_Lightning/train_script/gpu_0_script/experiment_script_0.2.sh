...
do
  ...
  do
    ...
    run_pretrain $gpu_device_1 $NEW_TYPE $PRETRAIN_EXP_TYPE group_aug group_norm group_model group_datasets
#    run_train_only $gpu_device_1 $NEW_TYPE group_aug group_norm group_model group_datasets
