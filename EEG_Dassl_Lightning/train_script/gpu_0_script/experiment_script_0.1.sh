...
current_exp="NeurIPS_competition/task_2_final_1"
...
#    run_al_full $gpu_device_0 $NEW_TYPE $test_case_16_microvolt_path group_aug group_norm group_model group_datasets
    ...
    run_predict_relabel $gpu_device_1 $NEW_TYPE $task_2_final_test_case group_aug group_norm group_model group_datasets
  done
done
