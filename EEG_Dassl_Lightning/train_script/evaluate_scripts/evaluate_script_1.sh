...
test_data_path="C:\wduong_folder\Dassl.pytorch-master\NeurIPS_competition\EEG_Dassl_Lightning\da_dataset\NeurIPS_competition\test_data_volt\NeurIPS_TL.mat"
...
run_ensemble_predict $gpu_device_1 $final_result_4_3 group_aug group_norm group_model group_datasets
