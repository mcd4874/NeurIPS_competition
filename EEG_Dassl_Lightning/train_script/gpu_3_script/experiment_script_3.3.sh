...
#echo ${EXP_SETUP[1]}
#
#run_full_active_learning $gpu_device_3 $test_path $model_update_al EXP_SETUP BEST_SETUP group_aug group_norm group_model group_datasets
...
#run_active_learning $gpu_device_3 $test_path $model_update_al EXP_SETUP BEST_SETUP group_aug group_norm group_model group_datasets
#
#run_predict_relabel $gpu_device_3 $AL_EXP_TYPE $test_path group_aug group_norm group_model group_datasets
#
#
#EXP_TYPE="NeurIPS_competition/final_result_14_3_1/al_model_2"
#USE_BEST_EXP="True"
#AL_EXP_TYPE="NeurIPS_competition/final_result_14_3_1/al_model_2.1"
#test_path="$test_case_16_microvolt_path"
#model_update_al="NeurIPS_competition/final_result_14_3_1/al_model_2"
#
#EXP_SETUP=("$EXP_TYPE" "$AL_EXP_TYPE")
#BEST_SETUP=("$USE_BEST_EXP")
#run_active_learning $gpu_device_3 $test_path $model_update_al EXP_SETUP BEST_SETUP group_aug group_norm group_model group_datasets
...
#EXP_TYPE="NeurIPS_competition/final_result_14_3_1/main_model_2"
#USE_BEST_EXP="True"
#AL_EXP_TYPE="NeurIPS_competition/final_result_15_3_1/al_model_2_2"
#model_update_al="NeurIPS_competition/final_result_14_3_1/main_model_2"
...
#        echo $AL_DIR
#        echo $test_path
#        run_simple_active_learning $gpu_device_3 $test_path $PRETRAIN_DIR $USE_BEST_EXP $AL_DIR $MODEL_UPDATE_AL_DIR
#
#      done
#    done
#  done
...
EXP_TYPE="NeurIPS_competition/final_result_15_3_1/main_model_3/pretrain_tune/6"
LIST_AUG_PREFIX=("$temp_aug")
LIST_NORMALIZE_PREFIX=("$no_norm")
TRAINER_MODEL_PREFIXS=("$mcdV1_prefix")
