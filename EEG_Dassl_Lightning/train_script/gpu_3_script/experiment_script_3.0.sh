...
#group_model=("$adapt_dann_aug_DSBN_prefix" "$adapt_equal_dann_aug_EDBN_prefix")

group_model=("$adapt_equal_cdan_aug_DSBN_prefix" "$adapt_equal_cdan_aug_prefix")
...
run_full $gpu_device_3 $experiment_case_2 $norm_none_prefix group_seed group_model group_datasets
