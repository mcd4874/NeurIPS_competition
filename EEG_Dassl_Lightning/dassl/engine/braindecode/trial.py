...
print("len 1 :",len(train_set))
print("len 2 : ",len(train_set[1]))
print("len 3 : ",len(train_set[0][0]))
print("len 4 : ",len(train_set[0][0][0]))
print("test ")
print("len 1 :",len(valid_set))
print("len 2 : ",len(valid_set[0]))
print("len 3 : ",len(valid_set[0][0]))
print("len 4 : ",len(valid_set[0][0][0]))
print("input window samples : ",input_window_samples)
print("n chans : ",n_chans)
...
trial_test = torch.ones((32,22,1125,1)).cuda()
print(model(trial_test))
