...
save_folder_A = "final_MI_A"
target_dataset_B_name = "dataset_B"
save_folder_B = "final_MI_B"
generate_data=True
data_path = "C:\\Users\\wduong\\mne_data\\finalMI"
start_id=1
end_id=4
test_dataset_A = setup_datasets(source_datasets,target_dataset_A_name,common_channel_A_B,path=data_path,save_folder=save_folder_A,generate_folder_data=generate_data,start_id=start_id,end_id=end_id)
start_id=4
end_id=6
test_dataset_B = setup_datasets(source_datasets,target_dataset_B_name,common_channel_A_B,path=data_path,save_folder=save_folder_B,generate_folder_data=generate_data,start_id=start_id,end_id=end_id)
generate_data_file([test_dataset_A,test_dataset_B],folder_name='final_MI_test')
