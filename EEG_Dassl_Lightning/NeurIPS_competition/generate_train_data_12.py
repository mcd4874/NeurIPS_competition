...
from NeurIPS_competition.util.support import (
    ...
    generate_data_file,print_dataset_info,print_info,get_dataset_A_ch,get_dataset_B_ch,shuffle_data,EuclideanAlignment,reduce_dataset
)
...
def load_source_data(target_channels,dataset_name="cho2017",montage=None):
    ...
    if dataset_name == "cho2017":
        ...
        epoch_X_src, label_src, m_src = load_BCI_IV(fmin=fmin, fmax=fmax, selected_chans=target_channels,montage=montage)
...
#
# generate_data_file([target_dataset_A],folder_name='case_16_A',file_name = 'NeurIPS_TL')
# generate_data_file([dataset_1],folder_name='case_16_A',file_name = 'dataset_1')
# generate_data_file([dataset_2],folder_name='case_16_A',file_name = 'dataset_2')
# generate_data_file([dataset_3],folder_name='case_16_A',file_name = 'dataset_3')
#
#
# generate_data_file([LA_dataset_1],folder_name='case_16_A/LA',file_name = 'dataset_1')
# generate_data_file([LA_dataset_2],folder_name='case_16_A/LA',file_name = 'dataset_2')
# generate_data_file([LA_dataset_3],folder_name='case_16_A/LA',file_name = 'dataset_3')
...
LA_B_m_src1 = {name: col.values for name, col in LA_B_m_src1.items()}
LA_B_m_src2 = {name: col.values for name, col in LA_B_m_src2.items()}
LA_B_m_src3 = {name: col.values for name, col in LA_B_m_src3.items()}
...
# #
generate_data_file([target_dataset_B],folder_name='case_16_B',file_name = 'NeurIPS_TL')
generate_data_file([dataset_1],folder_name='case_16_B',file_name = 'dataset_1')
generate_data_file([dataset_2],folder_name='case_16_B',file_name = 'dataset_2')
generate_data_file([dataset_3],folder_name='case_16_B',file_name = 'dataset_3')


generate_data_file([LA_dataset_1],folder_name='case_16_B/LA',file_name = 'dataset_1')
generate_data_file([LA_dataset_2],folder_name='case_16_B/LA',file_name = 'dataset_2')
generate_data_file([LA_dataset_3],folder_name='case_16_B/LA',file_name = 'dataset_3')

# generate_data_file([test_dataset_A,test_dataset_B],folder_name='test_case_16_microvolt')
...
generate_data_file([target_r_op_A],folder_name='case_16_A',file_name = 'dataset_A_r_op')
...
generate_data_file([target_r_op_B],folder_name='case_16_B',file_name = 'dataset_B_r_op')
