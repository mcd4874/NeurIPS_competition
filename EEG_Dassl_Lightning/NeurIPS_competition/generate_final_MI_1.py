...
# X_src1,y_src1,m_src1 = load_source_data(target_channels=common_channel_A_B,relabel_func=relabel,dataset_name="cho2017",subject_ids=[1,2,3,4])
# X_src2,y_src2,m_src2 = load_source_data(target_channels=common_channel_A_B,relabel_func=relabel,dataset_name="physionet",subject_ids=[1,2,3,4])
# X_src3,y_src3,m_src3 = load_source_data(target_channels=common_channel_A_B,relabel_func=relabel,dataset_name="BCI_IV",montage=montage,subject_ids=[1,2,3,4])
subject_ids = None
# subject_ids = [1,2]
...
save_folder_A = "final_MI_A_1"
test_folder_A = "final_MI_test_A_1"

target_dataset_B_name = "dataset_B"
save_folder_B = "final_MI_B_1"
test_folder_B = "final_MI_test_B_1"

generate_data=True
data_path = "C:\\Users\\wduong\\mne_data\\finalMI"

# test_dataset_A = setup_datasets(source_datasets,target_dataset_A_name,common_channel_A_B,save_folder=save_folder_A,generate_folder_data=generate_data)
# test_dataset_B = setup_datasets(source_datasets,target_dataset_B_name,common_channel_A_B,save_folder=save_folder_B,generate_folder_data=generate_data)
# generate_data_file([test_dataset_A,test_dataset_B],folder_name='test_case_16_microvolt')
start_id=1
end_id=4
setup_specific_subject_dataset(source_datasets,target_dataset_A_name,common_channel_A_B,path=data_path,save_folder=save_folder_A,test_folder=test_folder_A,generate_folder_data=generate_data,start_id=start_id,end_id=end_id)
start_id=4
end_id=6
setup_specific_subject_dataset(source_datasets,target_dataset_B_name,common_channel_A_B,path=data_path,save_folder=save_folder_B,test_folder=test_folder_B,generate_folder_data=generate_data,start_id=start_id,end_id=end_id)
