...
src3 = correct_EEG_data_order(epoch_X_src3,target_channels)
...
generate_data_file([dataset_1,dataset_2,dataset_3,target_dataset_A],folder_name='case_11_A')
generate_data_file([dataset_1,dataset_2,dataset_3,target_dataset_B],folder_name='case_11_B')
generate_data_file([test_dataset_A,test_dataset_B],folder_name='test_case_11_microvolt')
