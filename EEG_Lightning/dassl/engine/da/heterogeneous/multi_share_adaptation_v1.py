...
class MultiShareAdaptationV1(TrainerMultiAdaptation):
    """
    ...
    def training_step(self, batch, batch_idx):
        ...
        for u, y, d in zip(list_input_u, list_label_u, domain_u):
            ...
            logits = self.TargetClassifier(f)
        ...
        def count(label, name=""):
            ...
            print("batch {},  has {} label 0, {} label 1, and {} label 2, {} label 3, {} label 4, {} label 5".format(name,
                                                                                                                   count_0,
                                                                                                                   count_1,
                                                                                                                   count_2,
                                                                                                                   count_3,
        ...
        count(label.detach().cpu().numpy(),str(batch_idx))
