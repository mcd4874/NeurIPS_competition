...
class EEGNETV2(Backbone):
    ...
    def forward(self,input):
        ...
        h2 = self.d2( F.avg_pool2d(tmp_2,(1,self.avg_pool_1)))
        # print("h2 shape : ",h2.shape)
        tmp_3 = F.elu(self.b3(self.c3(h2)))
        h3 = self.d3(F.avg_pool2d(tmp_3,(1,self.avg_pool_2)))
        flatten = torch.flatten(h3, start_dim=1)

        return flatten

@BACKBONE_REGISTRY.register()
def eegnet_v2(pretrained=False,pretrained_path = '', **kwargs):
    print("params set up : ",kwargs)
    model = EEGNETV2(**kwargs)
