...
from dassl.data.data_manager_v1 import DataManagerV1, DataManagerV2, MultiDomainDataManagerV1,MultiDomainDataManagerV2
...
def trainer_setup(output_dir,cfg,benchmark=False,deterministic=False,seed=42,update_dataset=None):
    ...
    elif data_manager_type == "single_datasetV2":
        data_manager = DataManagerV2(cfg)
    ...
    use_early_stop = cfg.LIGHTNING_TRAINER.early_stop.use_early_stop
    early_stopping = EarlyStopping(monitor=monitor, patience=10)


    list_callbacks = [checkpoint_callback]
    if use_early_stop:
        print("use early stop and stop after {} patient epochs".format(10))
