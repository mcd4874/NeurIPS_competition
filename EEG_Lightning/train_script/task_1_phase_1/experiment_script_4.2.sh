...
test_case_path="${data_path_dir}/da_dataset/NeurIPS_1_filter/phase_1_task_1_test_case_1/phase_1_test_sleep.mat"
...
#LIST_EXP_TYPES=("phase_1_case_1" "phase_1_case_3")
LIST_EXP_TYPES=("phase_1_case_1")
...
#  run_full_multi_gpu $gpu_device_3 $task_exp group_aug group_norm group_model group_datasets
...
#  run_pretrain $gpu_device_3 $tune_cla_exp $task_exp $pretrain_best group_aug group_norm group_model group_datasets
  run_predict_task_1 $gpu_device_3 $tune_cla_exp $test_case_path group_aug group_norm group_model group_datasets
